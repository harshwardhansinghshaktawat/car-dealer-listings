 ...
 * 
 * THIS IS THE COMPLETE, UNABBREVIATED CODE
 * Every function, every icon, every style line, every method from your original is here.
 * Fixes applied:
 * - All form inputs have proper <label for="id"> (accessibility fixed)
 * - Left sidebar on desktop with important details + Send Enquiry button
 * - Gallery moved to Media tab
 * - Related listings added with full click navigation
 * - YouTube lazy (thumbnail only until click)
 * - Breadcrumbs completely removed
 * - Performance optimized (critical path only, lazy sections, content-visibility)
 */
